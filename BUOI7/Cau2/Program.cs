...
* Ý tưởng:
Bước 1: Tìm tất cả ước của n (không kể n)
Ước của n là số mà n chia hết.
Vd: n = 6: các ước là 1, 2, 3, 6. Không kể 6, còn 1, 2, 3.
Cách tìm ước: Duyệt từ 1 đến n-1, số nào chia hết cho n thì là ước.
B2: Tính tổng các ước
Cộng dồn tất cả ước tìm được
Lưu vào biến tongUoc
B3: So sánh tổng với n
Nếu tongUoc == n->số hoàn hảo
B4: In kết quả theo định dạng đề bài
* Mã giả:CHƯƠNG TRÌNH Kiểm tra số hoàn hảo
BẮT ĐẦU
    // Bước 1: Nhập n
    LẶP:
        In "Moi ban nhap n: "
...
//
// ------------------------------------------------------------
// TEST 4: So hoan hao thu 3 (n = 496)
// ------------------------------------------------------------
// Input:
//   496
//
...
//
// ------------------------------------------------------------
// TEST 7: So hoan hao thu 4 (n = 8128)
// ------------------------------------------------------------
// Input:
//   8128
//
